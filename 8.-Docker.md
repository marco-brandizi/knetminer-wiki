...
mapping. That's why you don't find the corresponding variables in `<specie>/maven-settings.xml`. Rather, they're defined in the [main POM][240], (the `docker` Maven profile 
defines the Docker-specific values).
