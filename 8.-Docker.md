...
[200]: https://github.com/Rothamsted/knetminer/tree/201904_new_docker/species
...
[220]: https://github.com/Rothamsted/knetminer/tree/201904_new_docker/common/quickstart/docker-run.sh
[230]: https://github.com/Rothamsted/knetminer/tree/201904_new_docker/common/quickstart/docker-run-rres-test.sh
...
If you want to run the Knetminer container against a new dataset, you have several options:
  ...
  * A variant of the previous method is that you map the container's build directory, `/root/knetminer-build`
  to your Knetminer codebase clone. This can be done via the [docker-run.sh script][220], by setting the 
  `KNET_HOST_CODEBASE_DIR`. This is quicker if you only have to try a new dataset (or a new version of an 
  existing one), including client changes/extensions. The the container rebuilds both upon each new run. 
  This cannot work if you need further changes (eg, the server WAR), since these are only considered when 
  ...
  * Finally, you can point to an host directory equivalent to the `specie/` directory on our codebase. Hence,
  ...
  `KNET_HOST_DATASET_DIR` before invoking such script. For instance, if you run this:
    ...
    ./docker-run.sh arabidopsis
    ```
  The container will look for instance files in `/tmp/species/arabidopsis`, in the host file system.  
...
docker run -p 8080:8080 -it --name arabidopsis \
  --volume /tmp/data/arabidopsis:/root/knetminer-data \  
  --volume /tmp/species:/root/knetminer-build/species \
  --env MAVEN_ARGS \
  knetminer/knetminer species/arabidopsis
```

[235]: https://github.com/Rothamsted/knetminer/tree/201904_new_docker
[237]: https://github.com/Rothamsted/knetminer/tree/201904_new_docker/common/quickstart
...
[240]: https://github.com/Rothamsted/knetminer/tree/201904_new_docker/common/quickstart/cleanup-volume.sh
...
[240]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/pom.xml
...
[250]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/common/aratiny/aratiny-ws/src/test/resources/knetminer-config/data-source.xml
...
[20]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/common/quickstart/Dockerfile
[30]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/common/quickstart/Dockerfile-base
[40]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/common/quickstart/Dockerfile-bare
[50]: https://hub.docker.com/r/andreptb/tomcat
[60]: https://github.com/Rothamsted/knetminer/tree/master/common/aratiny
[70]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/common/quickstart/runtime-helper.sh
[80]: https://aws.amazon.com/blogs/opensource/demystifying-entrypoint-cmd-docker
[90]: https://github.com/Rothamsted/knetminer/tree/201904_new_docker/species
[100]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/common/quickstart/docker-run.sh
...
[120]: https://github.com/Rothamsted/knetminer/blob/201904_new_docker/common/quickstart/build-helper.sh
