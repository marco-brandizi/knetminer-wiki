...
You can do that as follows.
  ...
  `/home/knetminer/wheat`
    ...
    2. Copy the Arabidopsis OXL file into `/home/knetminer/wheat/data/knowledge-network.oxl`. By default, all the Ketminer configurations look for this name in the data directory to get the dataset file.
  2. Run the command:
```bash
