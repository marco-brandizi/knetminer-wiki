...
5. Once built, use `docker run -p8080:8080 -it --rm knetminer-arabidopsis-dev` to run it on `localhost:8080`. Access the deployed GUI on `localhost:8080/client` and API via `localhost:8080/ws/`.
